...
while (a not in lista and b not in lista):
    lista.append(a)
    lista.append(b)
print(lista)
...
try:
    a = input("Podaj liczbe, z ktorej wylicze pierwiastek: ")
    a = int(a)
    wynik = math.sqrt(a)
    wynik = round(wynik,2)
    print("Pierwiastek wynosi: ",str(wynik))
except ValueError:
...
try:
    ...
    print("Blad! Podales znak zamiast liczby!")
